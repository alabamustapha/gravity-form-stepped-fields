      ...
      formatPhoneNumber () {
        ...
        if (input !== '') {
          if (input.startsWith('+')) {
            ...
            if (typeof country !== 'undefined') { this.phone = input.startsWith('0') === true ? '+' + country.phonecode + input.slice(1).replace(/\D/g, '') : '+' + country.phonecode + input.replace(/\D/g, '') } else { this.phone = input }
          }
