                          ...
                          <el-row :gutter="10" class="am-appointments-flex-row-middle-align">
                            ...
                            <el-col :lg="6" :sm="6">
                              ...
                              <template>
                                ...
                                <span v-if="app.bookings.length === 1" v-for="booking in app.bookings" class="am-appointment-data-phone">{{ ((user = getCustomerById(booking.customerId)) !== null ? user.phone : '') }}</span>
                        ...
                        <el-col :lg="9">
                          <el-row :gutter="10" class="am-appointments-flex-row-middle-align">
                            ...
                            <el-col :lg="12" :sm="6" v-if="$root.settings.role === 'customer'">
                              ...
                              <span @click.stop>
                                <el-tooltip effect="dark" :content="$root.labels.edit_appointment" placement="top">
                                  <el-button
                                      v-if="!(app.past || app.bookings[0].status === 'canceled' || app.bookings[0].status === 'rejected') && app.cancelable"
                                      size="mini"
                                      @click="showDialogEditAppointment(app.id)">
