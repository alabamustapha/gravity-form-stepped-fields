      ...
      <div class="am-attendees">
        <el-collapse>
          <el-collapse-item
              ...
              v-show="booking.show && options.entities.customers.find(customer => customer.id === booking.customerId)"
              :key="index"
              :name="booking.id"
              class="am-attendee">
            <template slot="title">
                ...
                <el-row :gutter="10">
                  ...
                  <el-col :sm="$root.settings.capabilities.canDelete === true ? 17 : 19">
                    <div class="am-attendee-name">
                      ...
                      <span class="am-attendee-email">{{ booking.customer.email }}</span>
                      <span
                          class="am-attendee-phone">{{ ((user = getCustomer(booking)) !== null ? user.phone : '') }}</span>
                    </div>
                  </el-col>
                  <el-col :sm="5">
            ...
            <div class="am-attendee-collapse">
              ...
              <el-row :gutter="10">
                <el-col :span="12" v-if="$root.settings.capabilities.canDelete === true">
                  <div class="">
                    <el-button
                ...
                <el-col :span="$root.settings.capabilities.canDelete === true ? 12 : 24">
                  <div class="">
                    <el-button
                        v-if="writeEvents"
