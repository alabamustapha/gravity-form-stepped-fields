        ...
        <div class="am-dialog-scrollable">
            ...
            <el-form :model="settings" ref="settings" label-position="top" @submit.prevent="onSubmit" :class="{'am-lite-container-disabled': $root.isLite}">
              ...
              <el-form-item label="placeholder">
                <label slot="label">
                  {{ $root.labels.recurring_placeholders }}:
                  <el-tooltip placement="top">
                    <div slot="content" v-html="$root.labels.recurring_placeholders_tooltip"></div>
                    <i class="el-icon-question am-tooltip-icon"></i>
                  </el-tooltip>
                </label>
                <el-input v-model="settings.recurringPlaceholders" type="textarea" auto-complete="off"></el-input>
              </el-form-item>
              <!-- /Recurring Description -->
