            ...
            <template>
              <el-tabs v-model="activeTab">
                <el-tab-pane :label="$root.labels.appointments" name="appointments">
                  <payments-meta-data ref="metaDataAppointments" :data="payments" tab="appointments"></payments-meta-data>
                </el-tab-pane>
                <el-tab-pane :label="$root.labels.events" name="events">
                  <payments-meta-data ref="metaDataEvents" :data="payments" tab="events"></payments-meta-data>
                </el-tab-pane>
              </el-tabs>
            </template>
          </el-collapse-item>
