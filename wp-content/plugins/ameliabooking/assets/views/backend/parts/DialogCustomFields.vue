    ...
    <div v-for="(booking, key) in appointment.bookings" class="am-customer-extras">
      ...
      <div class="am-custom-fields">
        ...
        >
          ...
          <!-- Uploaded Files -->
          <div v-else-if="customField.type === 'file' && hideAttachmentCustomField === false" v-for="(fileInfo, index) in appointment.bookings[key].customFields[customField.id].value" style="margin: 15px;">
            <a
                :key="index"
