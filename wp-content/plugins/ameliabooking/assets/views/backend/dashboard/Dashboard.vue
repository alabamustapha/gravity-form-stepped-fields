                          ...
                          <el-row :gutter="10" class="am-appointments-flex-row-middle-align">
                            ...
                            <el-col class="am-appointment-payment" :lg="6" :sm="6" :xs="12">
                              ...
                              <div class="am-appointment-payment-wrap">
                                ...
                                >
                                <h4>{{ getAppointmentPrice(app.serviceId, getAppointmentService(app), app.bookings) }}</h4>
                              </div>
                            </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fillAppointmentsChartStats: function (data, type) {
        this.statsLabels = []
        ...
        for (let dateKey in data) {
          ...
          for (let providerId in data[dateKey][type]) {
            ...
            dateAppointmentsRevenue += parseInt(data[dateKey][type][providerId].revenue)
          }
          ...
          if (dateAppointmentsAvailable === 0) {
            ...
            this.smallLineChartRevenueData.datasets[0].data.push(dateAppointmentsRevenue)
          }
        }
      },
      ...
      fillAppointmentsTablesStats: function (data) {
        ...
        for (let providerId in employeeData) {
          ...
          employeeTableData.push({
            imgSrc: this.pictureLoad(provider, true),
        ...
        for (let serviceId in serviceData) {
          ...
          serviceTableData.push({
            imgSrc: this.pictureLoad(service, false),
